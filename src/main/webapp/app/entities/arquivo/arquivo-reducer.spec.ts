...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './arquivo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARQUIVO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARQUIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARQUIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARQUIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARQUIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARQUIVO actions', async () => {
      const expectedActions = [
        {
