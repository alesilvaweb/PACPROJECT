...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './associado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSOCIADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSOCIADO actions', async () => {
      const expectedActions = [
        {
