...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contato.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTATO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTATO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTATO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTATO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTATO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTATO actions', async () => {
      const expectedActions = [
        {
