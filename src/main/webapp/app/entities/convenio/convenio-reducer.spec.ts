...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './convenio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONVENIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONVENIO actions', async () => {
      const expectedActions = [
        {
