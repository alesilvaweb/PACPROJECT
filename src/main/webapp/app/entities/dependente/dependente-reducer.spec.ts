...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPENDENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPENDENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPENDENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPENDENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPENDENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPENDENTE actions', async () => {
      const expectedActions = [
        {
