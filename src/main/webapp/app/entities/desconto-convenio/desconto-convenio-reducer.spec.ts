...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './desconto-convenio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESCONTOCONVENIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESCONTOCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESCONTOCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESCONTOCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESCONTOCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESCONTOCONVENIO actions', async () => {
      const expectedActions = [
        {
