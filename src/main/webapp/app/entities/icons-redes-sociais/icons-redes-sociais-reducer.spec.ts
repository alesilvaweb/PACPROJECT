...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './icons-redes-sociais.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ICONSREDESSOCIAIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ICONSREDESSOCIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ICONSREDESSOCIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ICONSREDESSOCIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ICONSREDESSOCIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ICONSREDESSOCIAIS actions', async () => {
      const expectedActions = [
        {
