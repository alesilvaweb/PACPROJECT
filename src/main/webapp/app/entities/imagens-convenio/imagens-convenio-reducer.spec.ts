...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGENSCONVENIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGENSCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGENSCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGENSCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGENSCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGENSCONVENIO actions', async () => {
      const expectedActions = [
        {
