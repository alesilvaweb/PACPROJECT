            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('imagen')}>
                  <Translate contentKey="aapmApp.imagensConvenio.imagen">Imagen</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                {/*</th>*/}
                <th className="hand" onClick={sort('convenio')}>
            ...
            <tbody>
              {imagensConvenioList.map((imagensConvenio, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {imagensConvenio.imagen ? (
                      <div>
                        {imagensConvenio.imagenContentType ? (
                          <a onClick={openFile(imagensConvenio.imagenContentType, imagensConvenio.imagen)}>
                            <img
                              src={`data:${imagensConvenio.imagenContentType};base64,${imagensConvenio.imagen}`}
                        ...
                        <span>
                          {imagensConvenio.imagenContentType}, {byteSize(imagensConvenio.imagen)}
                        </span>
                      </div>
                    ) : null}
                  </td>
