...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mensagem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENSAGEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENSAGEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENSAGEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENSAGEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENSAGEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENSAGEM actions', async () => {
      const expectedActions = [
        {
