...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parametro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAMETRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARAMETRO actions', async () => {
      const expectedActions = [
        {
