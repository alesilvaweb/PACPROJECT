        ...
        {parametroList && parametroList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="aapmApp.parametro.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('parametro')}>
                  <Translate contentKey="aapmApp.parametro.parametro">Parametro</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('descricao')}>
                  <Translate contentKey="aapmApp.parametro.descricao">Descricao</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('chave')}>
                  <Translate contentKey="aapmApp.parametro.chave">Chave</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('valor')}>
                  <Translate contentKey="aapmApp.parametro.valor">Valor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/parametro/${parametro.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="aapmApp.parametro.home.notFound">No Parametros found</Translate>
            </div>
          )
        )}
      </div>
      {totalItems ? (
        <div className={parametroList && parametroList.length > 0 ? '' : 'd-none'}>
