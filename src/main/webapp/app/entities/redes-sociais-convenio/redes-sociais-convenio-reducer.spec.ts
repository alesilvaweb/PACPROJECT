...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './redes-sociais-convenio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDESSOCIAISCONVENIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_REDESSOCIAISCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REDESSOCIAISCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REDESSOCIAISCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REDESSOCIAISCONVENIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REDESSOCIAISCONVENIO actions', async () => {
      const expectedActions = [
        {
