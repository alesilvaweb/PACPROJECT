...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPO actions', async () => {
      const expectedActions = [
        {
