  ...
  async function fetchReservas() {
    try {
      const response = await axios.get(
        `api/reservas?status.equals=Agendado&data.greaterThanOrEqual=2023-12-01&associadoId.equals=${account.id}&page=0&size=9999`
      );
...
const MinhasReservasLocal = () => (
  <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br">
    <MinhasReservas />
  </LocalizationProvider>
);

export default MinhasReservasLocal;
